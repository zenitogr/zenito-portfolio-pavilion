        ...
        >
          <header className="text-center mb-12">
            ...
            <div className="mt-4 space-y-1">
              ...
              <p className="text-sm">Email: {personalInfo.contact.email}</p>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <a
                ...
                className="p-6 rounded-lg bg-card text-card-foreground dark:glow-secondary hover:scale-105 transition-all duration-300"
              >
                <div className="flex items-center gap-2">
